...
parser.add_argument("--csv_file", type=str, default="sorted_ppdb_xxl_lexical.csv", help="CSV file with the rules")
...
output_file = open(f"opus_{args.num_rules}_{args.num_sentences}_xxl.en-sr-train.en", "w")
