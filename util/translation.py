...
model_checkpoint = "./Helsinki-NLP/shortXXL-opus-mt-tc-base-en-sh"
print("model named")
...
translated = model.generate(**tokenizer(padded_test_set,
                                        return_tensors="pt", padding=True), max_length=256)
print("translated generated")
trans_file = open("short_XXL_translation.txt", "w")
for t in translated:
